...
namespace web
{
	...
	typedef void (sys::Object::*HTTP_RECV_REQUEST_HANDLER)(const std::string& sessionID, sys::HttpRequest* data);

	class sys::HttpResponse;
	typedef void (sys::Object::*HTTP_RECV_RESPONE_HANDLER)(const std::string& sessionID, sys::HttpResponse* data);
