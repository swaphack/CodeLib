...
alg::mesh::MidpointTerrian::MidpointTerrian()
{
}
...
void alg::mesh::MidpointTerrian::setSrc(const math::Vector3& src)
{
    _src = src;
}

const math::Vector3& alg::mesh::MidpointTerrian::getSrc() const
{
    return _src;
}

void alg::mesh::MidpointTerrian::setDest(const math::Vector3& dest)
{
    _dest = dest;
}

const math::Vector3& alg::mesh::MidpointTerrian::getDest() const
{
    return _dest;
}

void alg::mesh::MidpointTerrian::setOffsetPosition(const math::Vector3& offset)
{
    _offsetPosition = offset;
}

const math::Vector3& alg::mesh::MidpointTerrian::getOffsetPosition() const
{
    return _offsetPosition;
}

std::vector<math::Vector3> alg::mesh::MidpointTerrian::createPoints(int count)
{
