...
namespace db
{
	...
	private:
		...
		*/
		static void createStructFile(const char* filename, const std::map<std::string, DBTable>& structFiles);
	...
	public:
		...
		* 
		*/
		static void createDataStruct(std::string headFilename, const DBContent* content);
		/*
		* 保存结构
		* 
		*/
