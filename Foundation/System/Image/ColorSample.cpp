...
Color3B::Color3B(uint8_t r, uint8_t g, uint8_t b) : red(r), green(g), blue(b)
{
...
void Color3B::mult(const float ratio)
{
	...
	green = (uint8_t)(red * ratio);
	blue = (uint8_t)(red * ratio);
}
...
Color4B::Color4B(uint8_t r, uint8_t g, uint8_t b, uint8_t a) : red(r), green(g), blue(b), alpha(a)
{
...
void sys::convertColor4FTo4B(const Color4F & f4, Color4B & b4)
{
	...
	b4.blue = (uint8_t)(f4.blue * COLOR_FLOAT_VALUE);
	b4.alpha = (uint8_t)(f4.alpha * COLOR_FLOAT_VALUE);
}
