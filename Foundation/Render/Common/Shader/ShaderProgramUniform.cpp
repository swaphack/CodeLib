...
{
	GLShader::setProgramUniformMatrix2(getProgramID(), getVarID(), count, value);
}
...
{
	GLShader::setProgramUniformValue(getProgramID(), getVarID(), v0, v1, v2, v3);
}

void render::ShaderProgramUniform::setValue(uint32_t v0, uint32_t v1, uint32_t v2)
{
	GLShader::setProgramUniformValue(getProgramID(), getVarID(), v0, v1, v2);
}

void render::ShaderProgramUniform::setValue(uint32_t v0, uint32_t v1)
{
	GLShader::setProgramUniformValue(getProgramID(), getVarID(), v0, v1);
}

void render::ShaderProgramUniform::setValue(uint32_t v0)
{
	GLShader::setProgramUniformValue(getProgramID(), getVarID(), v0);
}
