...
void render::Texture2DMultiSampleArray::setTextureStorage(int samples, TextureInternalFormat internalFormat, int width, int height, int depth, bool fixedSamplelocations)
{
...
void render::Texture2DMultiSampleArray::setTextureImage(int samples, TextureInternalFormat internalFormat, int width, int height, int depth, bool fixedSamplelocations)
{
