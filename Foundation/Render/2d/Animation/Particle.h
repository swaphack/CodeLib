...
namespace render
{
	...
	protected:
		// 加速度
		sys::Vector3 _speedAcceleration;
		// 角度变换速度
		sys::Vector3 _angleAcceleration;
		// 缩放变换速度
		sys::Vector3 _scaleAcceleration;
		// 色变速度
