...
enum class ClientArrayType
{
	...
	TANGENT_ARRAY = GL_TANGENT_ARRAY_EXT,
	BITANGENT_ARRAY = GL_BINORMAL_ARRAY_EXT,
};
...
enum class PixelStore
{
	// 从内存中选取图像数据的子框， 默认为0
	UNPACK_ROW_LENGTH = GL_UNPACK_ROW_LENGTH,
	// 从内存中选取图像数据的子框，从多少像素开始读取，默认为0
	UNPACK_SKIP_PIXELS = GL_UNPACK_SKIP_PIXELS,
	// 从内存中选取图像数据的子框，从多少行开始读取，默认为0
	UNPACK_SKIP_ROWS = GL_UNPACK_SKIP_ROWS,
	// 字节是否翻转， 默认false
	UNPACK_SWAP_BYTES = GL_UNPACK_SWAP_BYTES,
	// 二维纹理数组，跳过n层开始读取数据，默认为0
	UNPACK_SKIP_IMAGES = GL_UNPACK_SKIP_IMAGES,
	// 对方方式，32位最佳4，64位最佳8， 32=4*8， 64=8*8，默认4
	UNPACK_ALIGNMENT = GL_UNPACK_ALIGNMENT,
	// 三位纹理， 从内存中选取图像数据的子框，默认为0
	UNPACK_IMAGE_HEIGHT = GL_UNPACK_IMAGE_HEIGHT,
	// 针对1位的图像数据（每个像素只有一位的数据), 是否反向读取， 默认false
	UNPACK_LSB_FIRST = GL_UNPACK_LSB_FIRST,
...
enum class TextureExternalDataType
{
	UNSIGNED_BYTE = GL_UNSIGNED_BYTE,
	BYTE = GL_BYTE,
	UNSIGNED_SHORT = GL_UNSIGNED_SHORT,
...
enum class TextureEnvTargetv
{
	TEXTURE_ENV = GL_TEXTURE_ENV,
	TEXTURE_FILTER_CONTROL = GL_TEXTURE_FILTER_CONTROL,
};

enum class TextureEnvParameterv
{
	TEXTURE_ENV_MODE =GL_TEXTURE_ENV_MODE,
...
enum class TextureInternalBaseFormat
{
	RED = GL_RED,
	RG = GL_RG,
	RGB = GL_RGB,
...
enum class TextureInternalSizedFormat
{
	DEPTH_COMPONENT = GL_DEPTH_COMPONENT,
...
enum class PointSpriteCoordType
{
	LOWER_LEFT = GL_LOWER_LEFT,
	UPPER_LEFT = GL_UPPER_LEFT,
};
...
enum class TexBaseInternalFormat
{
	DEPTH_COMPONENT = GL_DEPTH_COMPONENT,
	DEPTH_STENCIL = GL_DEPTH_STENCIL,
	RED = GL_RED,
...
enum class TexSizedInternalFormat
{
	R8 = GL_R8,
	R8_SNORM = GL_R8_SNORM,
	R16 = GL_R16,
...
enum class GetTexLevelParameter
{
	TEXTURE_WIDTH = GL_TEXTURE_WIDTH,
	TEXTURE_HEIGHT = GL_TEXTURE_HEIGHT,
...
enum class TextureTargetCubeMapFace
{
	// 右边
	TEXTURE_CUBE_MAP_POSITIVE_X = GL_TEXTURE_CUBE_MAP_POSITIVE_X,
	// 左边
...
enum class Texture2DMultisampleTarget
{
	TEXTURE_2D_MULTISAMPLE = GL_TEXTURE_2D_MULTISAMPLE,
};

enum class Texture3DMultisampleTarget
{
	TEXTURE_2D_MULTISAMPLE_ARRAY = GL_TEXTURE_2D_MULTISAMPLE_ARRAY,
};
...
enum class FrameBufferParameter
{
...
enum  class AllFrameBufferParameter
{
	FRAMEBUFFER_DEFAULT_WIDTH = GL_FRAMEBUFFER_DEFAULT_WIDTH,
	FRAMEBUFFER_DEFAULT_HEIGHT = GL_FRAMEBUFFER_DEFAULT_HEIGHT,
	FRAMEBUFFER_DEFAULT_LAYERS = GL_FRAMEBUFFER_DEFAULT_LAYERS,
...
enum class RenderBufferParameter
{
...
enum class SubroutineUniformParameter
{
...
enum class GetProgramParameter
{
...
enum class ModifyProgramParameter
{
...
enum class ProgramStageParameter
{
...
enum class ProgramResourceNameInterface
{
	UNIFORM = GL_UNIFORM,
...
enum class ProgramResourceLocationIndexInterface
{
	PROGRAM_OUTPUT = GL_PROGRAM_OUTPUT,
};

enum class ProgramResourceLocationInterface
{
	UNIFORM = GL_UNIFORM,
	PROGRAM_INPUT = GL_PROGRAM_INPUT,
	PROGRAM_OUTPUT = GL_PROGRAM_OUTPUT,
...
enum class ProgramResourceIndexInterface
{
	UNIFORM = GL_UNIFORM,
	UNIFORM_BLOCK = GL_UNIFORM_BLOCK,
	PROGRAM_INPUT = GL_PROGRAM_INPUT,
...
enum class ProgramResourceInterface
{
	UNIFORM = GL_UNIFORM,
	ATOMIC_COUNTER_BUFFER = GL_ATOMIC_COUNTER_BUFFER,
	TRANSFORM_FEEDBACK_BUFFER = GL_TRANSFORM_FEEDBACK_BUFFER,
...
enum class BufferSizedInternalFormat
{
	R8 = GL_R8,
	R16 = GL_R16,
	R16F = GL_R16F,
...
enum class BufferImageInternalFormat
{
	DEPTH_COMPONENT = GL_DEPTH_COMPONENT,
	DEPTH_STENCIL = GL_DEPTH_STENCIL,
	//STENCIL_INDEX = GL_STENCIL_INDEX,
...
enum class BufferImageDataType
{
	UNSIGNED_BYTE = GL_UNSIGNED_BYTE,
	BYTE = GL_BYTE,
	UNSIGNED_SHORT = GL_UNSIGNED_SHORT,
...
enum class DrawElementsIndirectType
{
	ELEMENT_ARRAY_BUFFER = GL_ELEMENT_ARRAY_BUFFER,
};
...
enum class BufferPointerParameter
{
	_BUFFER_MAP_POINTER = GL_BUFFER_MAP_POINTER,
};

enum class GetVertexArrayIndexedParameter
{
...
enum class GetVertexArrayIndexedParameter64
{
	VERTEX_BINDING_OFFSET = GL_VERTEX_BINDING_OFFSET,
};

enum class GetVertexArrayParameter
{
	ELEMENT_ARRAY_BUFFER_BINDING = GL_ELEMENT_ARRAY_BUFFER_BINDING,
};

enum class GetVertexAttribParameter
{
...
enum class GetVertexAttribPointerParameter
{
	VERTEX_ATTRIB_ARRAY_POINTER = GL_VERTEX_ATTRIB_ARRAY_POINTER,
};

enum class MapBufferRangeAccess
{
	MAP_READ_BIT = GL_MAP_READ_BIT,
	MAP_WRITE_BIT = GL_MAP_WRITE_BIT,
	MAP_PERSISTENT_BIT = GL_MAP_PERSISTENT_BIT,
...
enum class VertexAttribFormatType
{
	BYTE = GL_BYTE,
	SHORT = GL_SHORT,
	INT = GL_INT,
...
enum class VertexAttribIPointerType
{
	BYTE = GL_BYTE,
	UNSIGNED_BYTE = GL_UNSIGNED_BYTE,
	SHORT = GL_SHORT,
...
enum class VertexAttribLPointerType
{
	DOUBLE = GL_DOUBLE,
};
...
enum class VertexAttribPackType
{
	INT_2_10_10_10_REV = GL_INT_2_10_10_10_REV,
	UNSIGNED_INT_2_10_10_10_REV = GL_UNSIGNED_INT_2_10_10_10_REV,
...
// 像素格式
enum class ReadPixelDataFormat
{
	RED = GL_RED,
	RED_INTEGER = GL_RED_INTEGER,
